...
\frame
{
  ...
  \item maximize information transmission
  \end{itemize}
...
\vspace{0.5cm}
It can be shown that these properties of linguistic elements and their interactions abide by universal laws, which can be formulated in a strict mathematical way - in analogy to the laws of the well-known natural sciences.
...
\frame[allowframebreaks]
{
  ...
  \item Gabriel Altmann, Reinhard K\"{o}hler, Paul Menzerath, Juhan Tuldava, Peter Grzybek, Wilhelm Fucks, ...
...
one person and that may produces a gradual spread. The greater the number of people that takes on this change,
...
\frame
{
  ...
  \item linguistic levels: phonemes, morphemes, lexical categories, noun phrases, verb phrases, and sentence types 
  \end{itemize}
...
do so by establishing linguistic units that might be used in the process of structuring of the
understanding of the linguistic system. As pointed by Saussure, it has always been sufficient
...
\vspace{0.5cm}
\cite{wang1996} shows that the monogenesis of language is a more probable hypothesis,
what could explain why some speech sound are more common than others in different languages. 
}
...
\item Word length plays a role in the self-regulation of language and is thus partially
      dependent on other linguistic properties. This is the problem of the \emph{interrelationship 
...
\note{
A number of recent experimental studies \citep{saffran1996b,Saffran1999,Saffran2003} show that both 
