...
and still so vaguely understood. Approximately 3000 languages are spoken nowadays, 
all of them hold remarkable distinctions one from another, but still have much in common. 
The purpose of this work is to analyse languages under a statistical point of view. 
...
to create a corpus of phonological segments, through the means of a pronouncing dictionary. 
...
words and utterances, and how are those contrasts established. The analysis may be used to create 
...
Heap's law. These laws were used to stablish an analyse on different levels and to investigate
the relationship among them. Language, as a mean of communication, was analyzed under
the information theory perspective. In order to better understand how language, as 
...
que nos distinga de outras espécies; e ainda tão pouco compreendida. Aproximadamente 3000 línguas são 
...
Este banco de dados é um levantamento estatístico dos inventário fonêmico de 451 línguas do mundo. 
...
assemelha-se ao que as línguas faladas realmente são. O estudo estatístico de uma linguagem é importante para 
