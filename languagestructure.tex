...
%is allowed in English and in German, but it does not happen in Portuguese. 
...
\end{quote}
It would not be a surprise to find those invented words in a dictionary someday, since every word is an invented linguistic sign. %, just as some self-invented words were already incorporated to the dictionaries. 
