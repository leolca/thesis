...
leading to a poorer performance on speed and accuracy tests. %for the low frequency ones.
...
%`natural'. 
As pointed out by \cite{mielke2005}, ``phonetically coherent classes like \textipa{/m n N/} and \textipa{/u o O/} 
